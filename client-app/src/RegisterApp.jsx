      ...
      <div className='form'>
        ...
        <form className='form-login bg-light'>
            ...
            <div className="form-group">
                ...
                <input value={userName} onChange={e => setUserName(e.target.value)} type="text" className="form-control form-login-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email"/>
            </div>
            <div className="form-group">
